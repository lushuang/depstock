                                                        ...
                                                        <div class="hidden-sm hidden-xs btn-group">
                                                            <c:if test="${QX.edit == 1 }">
                                                                <a id="offing1${vs.index+1}"
                                                                   <c:if test="${var.STATUS == '1'}">style="display: none;"</c:if> class="btn btn-info btn-xs" title="启动" onclick="onoff('${var.TIMINGBACKUP_ID}','1',this.id,'${vs.index+1}');">
                                                                    <i class="ace-icon glyphicon glyphicon-play" title="启动"></i>
                                                                </a>
                                                                <a id="oning1${vs.index+1}"
                                                                   <c:if test="${var.STATUS == '2'}">style="display: none;"</c:if> class="btn btn-info btn-xs" title="关闭" onclick="onoff('${var.TIMINGBACKUP_ID}','2',this.id,'${vs.index+1}');">
                                                        ...
                                                        <div class="hidden-md hidden-lg">
                                                            <div class="inline pos-rel">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <c:if test="${QX.edit == 1 }">
                                                                        <li>
                                                                            <a id="offing2${vs.index+1}"
                                                                               <c:if test="${var.STATUS == '1'}">style="display: none;cursor:pointer;"</c:if> onclick="onoff('${var.TIMINGBACKUP_ID}','1',this.id,'${vs.index+1}');" class="tooltip-info" data-rel="tooltip" title="启动">
																	<span class="blue">
																		<i class="ace-icon glyphicon glyphicon-play" title="启动"></i>
																	</span>
                                                                            </a>
                                                                        ...
                                                                        <li>
                                                                            <a id="oning2${vs.index+1}"
                                                                               <c:if test="${var.STATUS == '2'}">style="display: none;cursor:pointer;"</c:if> onclick="onoff('${var.TIMINGBACKUP_ID}','2',this.id,'${vs.index+1}');" class="tooltip-info" data-rel="tooltip" title="关闭">
																	<span class="blue">
																		<i class="ace-icon glyphicon glyphicon-off" title="关闭"></i>
																	</span>
                                                                            </a>
