                                ...
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="10">
                                            ...
                                            < tr >
                                            < td
                                            style = "width:75px;text-align: right;padding-top: 13px;" > 商品简述
                                            :</
                                            td >
                                            < td
                                            colspan = "10" >
                                            ...
                                            class
                                            = "center"
                                            style = "display:none" > < br / > < br / > < br / > < br / > < br / > < img
                                            src = "static/images/jiazai.gif" / > < br / > < h4
                                            class
                                            = "lighter block green" > 提交中... < / h4 > < / div >
                                                < / form >
                                                < / div >
                                                <!-- /.col -->
                                                < / div >
