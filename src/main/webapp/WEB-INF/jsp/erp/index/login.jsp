...
<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
    ...
    <div id="windows1">
        <div id="loginbox">
            ...
            <div class="controls">
                <div class="main_input_box">
                    <%--<font color="white"><span id="nameerr">Copyright © 东莞旅行趣有限公司 2017.05.01</span></font>--%>
                    <font color="white"><span id="nameerr">Copyright © 2017 Departure All Rights Reserved</span></font>
                </div>
            </div>
        </div>
    </div>
