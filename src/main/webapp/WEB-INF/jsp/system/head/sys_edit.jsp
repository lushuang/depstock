                                                        ...
                                                        <td colspan="100" class="center">
                                                            <div class="col-sm-9">
                                                                <label style="float:left;padding-left: 1px;padding-top:7px;">
                                                                    <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3"
                                                                           <c:if test="${pd.FHsmsSound == '0' }">checked="checked"</c:if> onclick="setFHsmsSoundType('0');"/>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                    <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3"
                                                                           <c:if test="${pd.FHsmsSound == '1' }">checked="checked"</c:if> onclick="setFHsmsSoundType('1');"/>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                    <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3"
                                                                           <c:if test="${pd.FHsmsSound == '2' }">checked="checked"</c:if> onclick="setFHsmsSoundType('2');"/>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                    <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3"
                                                                           <c:if test="${pd.FHsmsSound == '3' }">checked="checked"</c:if> onclick="setFHsmsSoundType('3');"/>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                    <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3"
                                                                           <c:if test="${pd.FHsmsSound == '4' }">checked="checked"</c:if> onclick="setFHsmsSoundType('4');"/>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                    <input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3"
                                                                           <c:if test="${pd.FHsmsSound == '5' }">checked="checked"</c:if> onclick="setFHsmsSoundType('5');"/>
                                            ...
                                            <form action="head/saveSys4.do" name="Form4" id="Form4" method="post">
                                                ...
                                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                <input name="login-field-1" onclick="openZc();" class="ace ace-switch ace-switch-3" type="checkbox"
                                                        ...
                                                        <td>
                                                            <label style="float:left;padding-left: 5px;padding-top:7px;">
                                                                <input name="login-field-1" onclick="openMu();" class="ace ace-switch ace-switch-3" type="checkbox"
