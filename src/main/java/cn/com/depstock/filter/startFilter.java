package cn.com.depstock.filter;

import cn.com.depstock.controller.base.BaseController;
import cn.com.depstock.plugin.websocketInstantMsg.ChatServer;
import cn.com.depstock.plugin.websocketOnline.OnlineChatServer;
import cn.com.depstock.util.Const;
...
public class startFilter extends BaseController implements Filter {
    ...
    public void reductionDbBackupQuartzState() {
        try {
            DBDepstock.executeUpdateFH("update DB_TIMINGBACKUP set STATUS = '2'");
