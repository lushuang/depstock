package cn.com.depstock.controller.fhdb.timingbackup;

import java.util.Date;
import java.util.Map;

import cn.com.depstock.controller.base.BaseController;
import cn.com.depstock.util.DBDepstock;
import cn.com.depstock.util.FileUtil;
...
import cn.com.depstock.service.fhdb.brdb.impl.BRdbService;
import cn.com.depstock.service.fhdb.timingbackup.impl.TimingBackUpService;
import cn.com.depstock.util.PageData;
import cn.com.depstock.util.Tools;
...
public class DbBackupQuartzJob extends BaseController implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            String kackupPath = DBDepstock.getDBDepstock().backup(TABLENAME).toString();//调用数据库备份
